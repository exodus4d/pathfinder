...
define([
    ...
    var showNewSystemDialog = function(map, options){
        ...
        var mapSystemCount = mapSystems.length;
        var mapTypeName = mapContainer.data('typeName');
        var maxAllowedSystems = Init.mapTypes[mapTypeName].defaultConfig.max_systems;
